            ...
            <td class="container" width="600">
                <div class="content">
                    ...
                    <div class="footer">
                        <table width="100%">
                            <tr>
                                <td class="aligncenter content-block">APPSYUDA</td>
                            </tr>
                        </table>
                    </div>
                </div>
